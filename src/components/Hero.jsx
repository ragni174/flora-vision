    ...
    <section className="relative pt-32 sm:pt-40 pb-16 px-6 sm:px-12 lg:px-12 xl:px-20 flex items-center overflow-hidden bg-transparent font-sans">
      ...
      <div className="max-w-[1400px] mx-auto w-full relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-0">
        ...
        <div className="relative z-20 w-full lg:w-1/2 flex flex-col pointer-events-none text-center lg:text-left items-center lg:items-start">
          ...
          >
            <button className="px-6 sm:px-8 py-3 rounded-xl border border-white/40 text-white bg-transparent hover:bg-white hover:text-black hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-all duration-500 text-[14px] sm:text-[15px] font-normal">
              Buy Now
            </button>
            <button className="flex items-center space-x-3 group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-white/40 flex items-center justify-center bg-transparent group-hover:bg-white group-hover:text-black group-hover:scale-110 group-hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-all duration-500 text-white">
          ...
          <motion.div 
            ...
            className="hidden md:block mt-16 lg:mt-24 backdrop-blur-3xl bg-white/5 border border-white/10 p-6 rounded-[32px] w-[300px] xl:w-[340px] shadow-[0_40px_100px_rgba(0,0,0,0.4)] hover:-translate-y-2 hover:bg-white/10 transition-all duration-700 pointer-events-auto group relative overflow-hidden"
          >
        ...
        <div className="relative z-30 mt-12 sm:mt-20 lg:mt-0 w-full lg:w-1/2 flex justify-center lg:justify-end">
          <motion.div 
            ...
            className="atmospheric-box bg-[#1d241d]/30 border border-white/10 w-full max-w-[340px] xl:max-w-[380px] h-[400px] sm:h-[440px] xl:h-[480px] rounded-[40px] sm:rounded-[48px] p-6 xl:p-8 flex flex-col justify-end shadow-[0_60px_120px_rgba(0,0,0,0.5)] hover:-translate-y-4 hover:bg-[#1d241d]/50 transition-all duration-700 pointer-events-auto group relative"
          >
            ...
            <div className="absolute -top-16 sm:-top-20 left-1/2 -translate-x-1/2 w-[240px] sm:w-[280px] xl:w-[320px] h-[220px] sm:h-[260px] xl:h-[300px] flex items-end group-hover:scale-105 transition-transform duration-700 origin-bottom pointer-events-none z-20">
            ...
            <div className="mt-auto">
              ...
              <button className="w-max px-8 sm:px-10 py-2.5 sm:py-3 rounded-xl border border-white/30 text-gray-200 bg-transparent hover:bg-white hover:text-black transition-all duration-500 text-[14px] sm:text-[15px] font-normal mb-6 sm:mb-8">
                Buy Now
              </button>
